...
/// <summary>
/// OrbitCameraController class establishes controls for camera movement within the Bridge Creator scene
/// </summary>
public class OrbitCameraController : MonoBehaviour
{
    public static OrbitCameraController instance; //bridge Creator instance is accessible to other scripts
    ...
    /// <summary>
    /// instance is established before the first frame is called so other scripts can access the OrbitCameraController
    /// </summary>
    private void Awake()
    {
        if (instance == null)
